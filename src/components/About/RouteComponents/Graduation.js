            ...
            <div className="graduation">
                <div className="graduation__container">
                    ...
                    <div className="graduation__description">
                        ...
                        <h2><FontAwesomeIcon icon={faCalendarDays} className="internships__calendar" />&nbsp;&nbsp;20/08/2020 - 27/06/2024</h2>
                        <p>I completed my BS in Computer Engineering from COMSATS Lahore.</p>
                    </div>
                </div>
            </div>
        </>
